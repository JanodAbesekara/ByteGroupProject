...
export default function Home() {
  return (
    <div>
      ...
      <label for="distract">Distract</label>
        <br></br>
              <select name="districts" className="select">
        ...
        <div className="s3">
             <label for="radiobuttob" className="inputcl">Class Type</label>
                   <br></br>
           
           <ul>
            <li>
                 <input type="radio" name="classType" value="individual" /> Individual
                 
                 
            </li>
                     
            <li>
                 <input type="radio" name="classType" value="group" /> Group
            </li>     
          </ul>
    </div>
       </section> 
