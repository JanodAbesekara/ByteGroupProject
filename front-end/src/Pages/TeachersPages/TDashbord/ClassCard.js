...
export default function ClassCard(subjectData) {
  ...
  const handleDelete = () => {
    ...
    const confirmation = window.confirm('Are you sure you want ot delete the subject?');
    ...
    <div>
      ...
      >
        ...
        >
            ...
            {isEditing ? (
                <>
                  <input
                    ...
                    style={{ margin: "4px 6px", fontSize: "14px", width: "100%" }}
                  />
                  <input
                    type="text"
                    name="experience"
          ...
          <div style={{width:"12%",display:"flex",flexDirection:"column",paddingRight:"5px"}}>
          {isEditing ? (
                <button style={{ margin: "5px", border:"none", borderRadius:"6px", backgroundColor:"#4de84a", color:"#fff", padding:"3px 0px"}} onClick={handleSave}>Save</button>
              ) : (
                <button style={{ margin: "5px", border:"none", borderRadius:"6px", backgroundColor:"green", color:"#fff", padding:"3px 0px" }} onClick={handleEdit}>Edit</button>
              )}
            <button onClick={handleDelete} style={{ margin: "5px", border:"none", borderRadius:"6px", backgroundColor:"red", color:"#fff", padding:"3px 0px" }}>Delete</button>
          </div>
          </div>
        </div>
      </div>
