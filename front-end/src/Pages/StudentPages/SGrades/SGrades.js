...
function SGrades() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`api/assignment/getGrade`, { params: { email: userEmail } })
      .then((response) => {
                  ...
                  {grades.map((eachOne) => (
                    <TableRow>
                      <TableCell sx={{ textAlign: "center" }}>
                        <a href={`mailto:${eachOne.teacherEmail}`}>
                          {eachOne.teacherEmail}
                        </a>
                      </TableCell>
                      <TableCell sx={{ textAlign: "center" }}>
                        {eachOne.subject}
                      ...
                      <TableCell
                        sx={{
                          textAlign: "center",
                          backgroundColor: getBackgroundColor(eachOne.grade),
                        }}
                      >
                        {eachOne.grade}
                      </TableCell>
